		...
		<script type="text/javascript">
			...
			function deletePersonal(id){
				layer.confirm(	
								...
								{icon: 3, title:'提示'},
								function(){
								location.href="${pageContext.request.contextPath }/deletePersonal.html?id="+id;
					});
			...
			function changePage(currentPage){
				...
				location.href = "${pageContext.request.contextPath }/personal_list.html?currentPage="
			...
			<form id="searchForm" class="layui-form" action="">
				<div class="layui-form-item">
					<div class="layui-inline tool-btn">
						<!-- 添加按钮 -->
						<a href="${pageContext.request.contextPath }/admin/index/personal_add.jsp" class="layui-btn layui-btn-mini layui-btn-normal  go-btn" data-id="1"><i class="layui-icon">&#xe654;</i>添加</a>
					</div>
			...
			<div class="layui-form" id="table-list">
				<table class="layui-table" lay-even lay-skin="nob">
					...
					<tbody>
						...
						<c:forEach items="${page.list }" var="personal" varStatus="var" >
							<tr>
								<td><input type="checkbox" name="id" value="${personal.id }" lay-skin="primary" data-id="1"></td>
								<td >${var.count + page.index }</td>
								<td><a>${personal.pname }</a></td>
								<td><a>${personal.age }</a></td>
								<td><a>${personal.phone }</a></td>
								<td><a>${personal.email }</a></td>
								<td><a>${personal.work }</a></td>
								
								<td>
									<div class="layui-inline">
										<a href="${pageContext.request.contextPath }/personal_show.html?id=${personal.id }" class="layui-btn layui-btn-mini layui-btn-normal  go-btn" data-id="1"><i class="layui-icon">&#xe642;</i>修改</a>
										<button onclick="deletePersonal(${personal.id})" class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="1" data-url="del.html"><i class="layui-icon">&#xe640;</i></button>
									</div>
								</td>
							</tr>
