...
<html>
	<head>
		...
		<script type="text/javascript">
			function edit() {
	    	 if(window.confirm('您确定要修改该房源信息吗？')) {
	                $("#editForm").submit();
	            } 
	...
	<body>
		<div class="wrap-container">
			<form id="editForm" class="layui-form" action="${pageContext.request.contextPath }/house_edit.html" 
				method="post" target="_parent" enctype="multipart/form-data" style="width: 90%;padding-top: 20px;" >
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="name" value="${house.name }" required lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="address" value="${house.address }" required lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="price" value="${house.price }" required lay-verify="required" placeholder="请输入价格" autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="area" value="${house.area }" required lay-verify="required" placeholder="请输入面积" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="huxing" value="${house.huxing }" required lay-verify="required" placeholder="请输入户型" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<c:if test="${house.is_rent ==1}">
								<input type="radio" name="is_rent" value="1" title="已被租借" checked>
							...
							<c:if test="${house.is_rent ==0}">
								...
								<input type="radio" name="is_rent" value="0"  title="未被租借" checked>
							</c:if>
						</div>
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea name="house_desc" placeholder="请输入描述" class="layui-textarea">${house.house_desc}</textarea>
						</div>
					</div>
