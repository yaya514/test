	...
	<head>
		...
		<script type="text/javascript">
			...
			function changePage(currentPage){
				...
				location.href = "${pageContext.request.contextPath }/record_list.html?currentPage="
					+ currentPage + "&searchName="+searchName;
			}
			
			function search(){
				var searchName = $("#searchName").val();
				location.href = "${pageContext.request.contextPath }/record_list.html?searchName="+searchName;
			}
		...
		<div class="page-content-wrap">
			<form class="layui-form" action="" >
				<div class="layui-form-item">
					...
					<button onclick="search()" class="layui-btn layui-btn-normal" lay-submit="search">搜索</button>
				</div>
			</form>
