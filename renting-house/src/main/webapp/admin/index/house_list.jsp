		...
		<script type="text/javascript">
			...
			function deleteHouse(id){
				layer.confirm(	
								...
								{icon: 3, title:'提示'},
								function(){
								location.href="${pageContext.request.contextPath }/deleteHouse.html?hid="+id+"";
					});
			...
			function changePage(currentPage){
				...
				location.href = "${pageContext.request.contextPath }/house_list.html?currentPage="+ currentPage + "&searchPrice="+searchPrice;
			}
			
			function search(){
				var searchPrice = $("#searchPrice").val();
				location.href = "${pageContext.request.contextPath }/house_list.html?searchPrice="+searchPrice;
			}
					...
					<tbody>
						...
						<c:forEach items="${page.list }" var="house" varStatus="var" >
							<tr>
								...
								<td>
									<div class="layui-inline">
										<a href="${pageContext.request.contextPath }/house_show.html?hid=${house.hid }" class="layui-btn layui-btn-mini layui-btn-normal  go-btn" data-id="1"><i class="layui-icon">&#xe642;</i>修改</a>
										<button onclick="deleteHouse(${house.hid})" class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="1" data-url="del.html"><i class="layui-icon">&#xe640;</i></button>
									</div>
								</td>
							</tr>
						</c:forEach>
