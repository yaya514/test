...
<html>
	<head>
		...
		<script type="text/javascript">
			function edit() {
	    	 if(window.confirm('您确定要修改该租户信息吗？')) {
	                $("#editForm").submit();
	            } 
	...
	<body>
		<div class="wrap-container">
			<form id="editForm" class="layui-form" action="${pageContext.request.contextPath }/personal_edit.html" 
				method="post" target="_parent" style="width: 90%;padding-top: 20px;" >
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="pname" value="${personal.pname }" required lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="age" value="${personal.age }" required lay-verify="required" placeholder="请输入年龄" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="email" value="${personal.email }" required lay-verify="required" placeholder="请输入邮箱" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">工作单位：</label>
						<div class="layui-input-block">
							<input type="text" name="work" value="${personal.work }" required lay-verify="required" placeholder="请输入单位" autocomplete="off" class="layui-input">
						</div>
					</div>
