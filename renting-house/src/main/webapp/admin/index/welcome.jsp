			...
			<div class="row">
				...
				<div class="welcome-edge col-lg-3">
								  ...
								  <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg"></i></a>
								    <div class="comment-main">
								      <header class="comment-header">
								        <div class="comment-meta"><a class="comment-author" href="#">某人</a> 评论于
								          <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2019-4-1 15:20</time>
								        </div>
								      </header>
								      <div class="comment-body">
								        <p><a href="#">@某人</a> 沛沛租房网真不错 (=・ω・=)</p>
								      </div>
								    </div>
								  </li>
								  <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg"></i></a>
								    <div class="comment-main">
								      <header class="comment-header">
								        <div class="comment-meta"><a class="comment-author" href="#">佚名</a> 评论于
								          <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2019-3-29 17:59</time>
								        </div>
								      </header>
								      <div class="comment-body">
								        <p><a href="#">@佚名</a> 房源多，价格实惠，以后找房子就来这里，哈哈(｀・ω・´)！</p>
								      </div>
								    </div>
								  </li>
								   <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg"></i></a>
								    <div class="comment-main">
								      <header class="comment-header">
								        <div class="comment-meta"><a class="comment-author" href="#">落叶</a> 评论于
								          <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2019-2-19 10:09</time>
								        </div>
								      </header>
								      <div class="comment-body">
								        <p><a href="#">@落叶</a> 这里租的房子性价比高 (ﾉ≧∀≦)ﾉ！！！</p>
								      </div>
								    </div>
								  </li>
								  <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg"></i></a>
								    <div class="comment-main">
								      <header class="comment-header">
								        <div class="comment-meta"><a class="comment-author" href="#">慕枫</a> 评论于
								          <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2019-1-10 11:50</time>
								        </div>
								      </header>
								      <div class="comment-body">
								        <p><a href="#">@慕枫</a> 还行！ (。-`ω´-)</p>
								      </div>
								    </div>
								  </li>
								</ul>
					...
					<div class="panel panel-default contact-panel">
						...
						<div class="panel-body">
							<p>QQ：2333333</p>
							<p>E-mail:2333333@qq.com</p>
							<p>哔哩哔哩 (゜-゜)つロ 干杯~-bilibili</p>
						</div>
					</div>
				</div>
			</div>
